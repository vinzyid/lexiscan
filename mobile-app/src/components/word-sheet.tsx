      ...
      <Pressable className="flex-1 items-center justify-center bg-black/50 px-6" onPress={onClose}>
        <View className="w-full rounded-[32px] bg-surface p-6">
          <View className="mb-5 flex-row items-center justify-between">
            <Text className="font-opendyslexic text-[10px] font-bold uppercase tracking-widest text-primary">
              🔍 KATA TERPILIH
            </Text>
            <Pressable
              onPress={onClose}
          ...
          <Text
            className="mb-6 text-center font-opendyslexic font-bold text-text-main"
            style={{ fontSize: 40, lineHeight: 56, letterSpacing: 1.5 }}>
            {word}
          </Text>

          <Text className="mb-3 font-opendyslexic text-[10px] font-bold uppercase tracking-widest text-text-muted">
            SUKU KATA
          </Text>
          <View className="flex-row flex-wrap justify-center">
            {syllables.map((syllable, index) => (
              <View key={index} className="mb-2 mr-2 rounded-2xl bg-primary/10 px-4 py-2.5">
                <Text
                  className="font-opendyslexic font-bold text-primary"
